...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <div class="header">
		<h2>Search For Jobseekers</h2>
	</div>
	<center>
	<form action="search-database.php" method="post">
Search: <input type="text" name="search" placeholder=" Search here ... "/ required>
<input type="submit" value="Submit" />
<br></br>
<center>
<h5>This search engine allows you to search for Job seekers 
 using the following criteria</h5>
 </center>
...
<ul>
  ...
  <li>Minimum number of GCSE passes</li>
  <li>Specific educational qualification</li>
  <li>Specific professional qualification</li>
  <li>Specific skill</li>
